...
const {
  ...
  deleteUser,
  deleteMe,
  getUserById, // Import new function
...
module.exports = (io) => { // Export a function that takes io as an argument
   ...
   */
  router.post('/login', (req, res) => loginUser(req, res, io)); // Pass io to loginUser
  ...
  router.delete('/me', protect, (req, res) => deleteMe(req, res, io)); // Pass io to deleteMe
   ...
   */
  router.get('/:id', protect, adminProtect, getUserById); // Get user by ID
